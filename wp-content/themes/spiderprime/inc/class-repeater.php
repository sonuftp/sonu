                ...
                <label>
                  <span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
                    <select <?php $this->link(); ?>>
                        <option value="0"><?php esc_html_e('Select Slider Category','spiderprime'); ?></option>
                        <?php
                            foreach ( $this->cats as $cat ){
                                printf('<option value="%1$s" %2$s>%3$s</option>', $cat->term_id, selected($this->value(), $cat->term_id, false), $cat->name);
                            }
                        ?>
                    </select>
                </label>
