...
if(!function_exists('spiderprime_calltoaction_section')){
	function spiderprime_calltoaction_section( $args ){
	 ...
	 if(!empty($page_id)) { ?>
		<div class="banner bannercalltoaction parallax-window" <?php if(!empty( $section_bg_image )) { ?> data-parallax="scroll" data-image-src="<?php echo esc_url( $section_bg_image ); ?>" <?php } ?>>
			<div class="container">
				<?php  
