    ...
    <form role="search" method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>">
      <div id="searchbox">
        <input type="text" id="searchinput" value="<?php echo get_search_query(); ?>" name="s" id="s"
               class="searchbox_search" placeholder="<?php echo __('Search...', "portfolio-gallery"); ?>"/>
          ...
          <div class="blog-post">
            ...
            <div class="blog-post-content">
              ...
              <a href="<?php the_permalink(); ?>" class="read_more"
                 style="text-align:right;"><?php echo __('More info', "portfolio-gallery"); ?></a>
            </div>
          </div>
        <?php endwhile;
      ...
      if (have_posts()) {
        ...
        <div id="image_list_top" class="image_list_top portfolio_list da-thumbs <?php echo $content_post_effect; ?>">
          ...
          while (have_posts()):
            ...
            ?>
            <div class="SearchPost <?php echo($article_class == "da-empty" ? "da-empty" : ""); ?>"
              ...
              <article
                ...
                <h4 rel="content-post-<?php echo $id; ?>-title"><?php the_title(); ?></h4>
