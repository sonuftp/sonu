...
<body <?php body_class(); ?>>
	...
	<div class="sb-home-img">
		...
		<img alt="home-img" src="<?php if (get_theme_mod( 'slider_img' )) : echo get_theme_mod( 'slider_img' );  else :  echo get_template_directory_uri() . '/img/home.png'; endif; ?>"/>
